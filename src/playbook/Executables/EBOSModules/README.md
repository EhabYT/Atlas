...
- Path: `\EBOSModules\Tools\multichoice.exe`
- SHA256 Hash: `6AB2FF0163AFE0FAC4E7506F9A63293421A1880076944339700A59A06578927D`
- Source: https://github.com/EBOS/EBOS-Utilities/releases/download/multichoice-v0.4/multichoice-compressed.exe
- Repository: https://github.com/EBOS/EBOS-Utilities
- Version: v0.4
- Renamed to `multichoice.exe`
- License: [GNU General Public License v3.0](https://github.com/EBOS/utilities/blob/main/LICENSE)
- Last Verified: 5/24/2024 by Xyueta

## SetTimerResolution & MeasureSleep

- Path: `\EBOSModules\Tools\SetTimerResolution.exe`
    ...
    - Version: v1.0.0
- Path: `\EBOSDesktop\3. General Configuration\Timer Resolution\! MeasureSleep.exe`
...
> [!NOTE]
> This is included in the Playbook and isn't in the EBOSModules.
