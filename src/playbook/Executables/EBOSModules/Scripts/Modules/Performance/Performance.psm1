...
function Disable-AutoFolderDiscovery {
    & "$windir\EBOSDesktop\4. Interface Tweaks\File Explorer Customization\Automatic Folder Discovery\Disable Automatic Folder Discovery (default).cmd" /justcontext
}
