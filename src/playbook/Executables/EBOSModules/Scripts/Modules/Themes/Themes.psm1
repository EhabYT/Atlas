...
function Set-ThemeMRU {
    if ([System.Environment]::OSVersion.Version.Build -ge 22000) {
        ...
        Set-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes" -Name "ThemeMRU" -Value "$((@(
            "ebos-v0.4.x-dark.theme",
            "ebos-v0.4.x-light.theme",
            "ebos-v0.5.x-dark.theme",
            "ebos-v0.5.x-light.theme",
            "ebos-cyan.theme",
            "ebos-liquid-glass.theme",
            "ebos-solid.theme",
            "dark.theme",
            "aero.theme"
...
function Set-LockscreenImage {
    param (
        [ValidateNotNullOrEmpty()]
        [string]$Path = "$([Environment]::GetFolderPath('Windows'))\EBOSModules\Wallpapers\lockscreen_dark.png"
    )
