...
# Duplicate Ultimate Performance power scheme, customize it and make it the EBOS power scheme
...
powercfg /changename scheme_current "EBOS Power Scheme" "Power scheme optimized for optimal latency and performance."
...
& "$windir\EBOSModules\Scripts\toggleDev.cmd" -Disable '@("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI")' | Out-Null
