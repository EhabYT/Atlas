...
if %errorlevel%==1 (
	call "%windir%\EBOSDesktop\3. General Configuration\Hibernation\Disable Hibernation (default).cmd" /silent
) else (
	call "%windir%\EBOSDesktop\3. General Configuration\Hibernation\Enable Hibernation.cmd" /silent
)
