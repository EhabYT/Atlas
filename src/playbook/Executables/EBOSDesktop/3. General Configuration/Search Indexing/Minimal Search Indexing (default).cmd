...
set "stateValue=1"
set "scriptPath=%~f0"
set indexConfPath="%windir%\EBOSModules\Scripts\indexConf.cmd"
...
if not exist "%indexConfPath%" (
    echo The 'indexConf.cmd' script wasn't found in EBOSModules.
    pause
    exit /b 1
)
...
%indexConf% /include "%windir%\EBOSDesktop"
