...
if /i not "%~1"=="/silent" if /i not "%~1"=="/justcontext" call "%windir%\EBOSModules\Scripts\serviceWarning.cmd" %*
...
call "%windir%\EBOSModules\Scripts\setSvc.cmd" Spooler 4
call "%windir%\EBOSModules\Scripts\setSvc.cmd" PrintWorkFlowUserSvc 4

call "%windir%\EBOSModules\Scripts\settingsPages.cmd" /hide printers
